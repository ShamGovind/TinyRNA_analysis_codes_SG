...
#vlues for : "No homolog", "homolog in C.elegans", "homolog+26G RNA target in C. elegans L4", "homolog+26G RNA target in C. elegans GA" )
...
#create data frame with these values
